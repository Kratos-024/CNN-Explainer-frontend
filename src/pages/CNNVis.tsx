...
const CNNVisApp = () => {
  ...
  return (
    <div className="w-full relative min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      <nav className="bg-white shadow-md flex justify-between py-4 px-6">
        <h1 className="text-xl font-bold text-gray-800">CNN Visualizer</h1>
        <a href="/dropout-effect" className="text-md font-bold text-gray-800">
          Dropout-Effect
        </a>
      </nav>
